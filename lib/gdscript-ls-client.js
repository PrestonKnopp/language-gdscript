  ...
  start(port) {
    return new Promise((resolve, reject) => {
      ...
      const onOpen = () => {
        ...
        // Emit open so that our client can save a ref to the socket which is
        // required as AutoLanguageClient.createRpcConnection() uses the socket
        // immediately after this promise resolves.
